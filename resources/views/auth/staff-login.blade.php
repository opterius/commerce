    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-md p-8">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900">{{ __('auth.staff_login_title') }}</h1>
                <p class="mt-2 text-sm text-gray-600">{{ __('auth.staff_login_subtitle') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('staff.login') }}">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('staff.password.request') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
