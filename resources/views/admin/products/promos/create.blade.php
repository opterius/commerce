<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="text-lg font-semibold text-gray-800">{{ __('products.create_promo') }}</h2>
        </div>
    </x-slot>

    <form method="POST" action="{{ route('admin.promo-codes.store') }}" x-data="{ appliesTo: '{{ old('applies_to', 'all') }}' }">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    ]" :selected="old('type', 'percent')" required />
                    ...
                    {{-- Recurring --}}
                    <div>
                        <x-checkbox name="recurring" value="1" :label="__('products.promo_recurring')" :checked="old('recurring')" />
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    {{-- Active --}}
                    <x-checkbox name="is_active" value="1" :label="__('common.active')" :checked="old('is_active', true)" />

                    {{-- Notes --}}
                    <x-textarea name="notes" :label="__('products.promo_notes')" :value="old('notes')" rows="3" />
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 mt-6">
            ...
            <x-button>{{ __('products.create_promo') }}</x-button>
        </div>
    </form>
</x-admin-layout>
